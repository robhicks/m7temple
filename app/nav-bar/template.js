...
elementOpen("a", "fab6b243-2286-415f-ac8f-f84f92752aeb", hoisted1, "onclick", function ($event) {
  var $element = this;
ctrl.go('/home/authenticated')}, "class", ctrl.stateContains('home'))
  elementOpen("img", "1c16fc49-ca1f-49d7-ac83-f337600bfd70", hoisted2)
  elementClose("img")
  elementOpen("span")
    text("Home")
  elementClose("span")
elementClose("a")
elementOpen("nav", "b6ebdfb9-e368-49d4-bdec-c2c4c23486c0", hoisted3)
