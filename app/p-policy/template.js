...
elementOpen("h3")
  ...
  ")
elementClose("h3")
elementOpen("ol", "0560ab41-13ff-4018-aaf2-0204b052165d", hoisted1)
  elementOpen("li")
    text(" \
     ...
     \
        ")
    elementOpen("ol", "17aca46f-0104-4995-9706-b20cf683f599", hoisted2)
      elementOpen("li")
...
elementOpen("h3")
  ...
  ")
elementClose("h3")
elementOpen("ol", "586fd6f2-6b1c-4912-be7a-f1c0ab943fb5", hoisted3)
  elementOpen("li")
    text(" \
