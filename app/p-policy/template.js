...
elementOpen("h3")
  ...
  ")
elementClose("h3")
elementOpen("ol", "0e924c09-2d38-4d94-afd6-2174f8fafb91", hoisted1)
  elementOpen("li")
    text(" \
     ...
     \
        ")
    elementOpen("ol", "c33dc6b2-3569-4a9b-ae4e-5dad5cb483f9", hoisted2)
      elementOpen("li")
...
elementOpen("h3")
  ...
  ")
elementClose("h3")
elementOpen("ol", "cfd1df69-b13b-4f58-bd55-f7d06de4a170", hoisted3)
  elementOpen("li")
    text(" \
