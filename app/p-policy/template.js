...
elementOpen("h3")
  ...
  ")
elementClose("h3")
elementOpen("ol", "661cc357-544b-4ecf-89fc-50b540640ac8", hoisted1)
  elementOpen("li")
    text(" \
     ...
     \
        ")
    elementOpen("ol", "81f79d9a-398d-4020-9ccc-a798f64ff064", hoisted2)
      elementOpen("li")
...
elementOpen("h3")
  ...
  ")
elementClose("h3")
elementOpen("ol", "0e428f0c-20f1-4866-be89-2d9be9b9ddca", hoisted3)
  elementOpen("li")
    text(" \
