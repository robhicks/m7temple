...
elementOpen("h3")
  ...
  ")
elementClose("h3")
elementOpen("ol", "a545ee2b-9c54-499b-99dd-1f038258c907", hoisted1)
  elementOpen("li")
    text(" \
     ...
     \
        ")
    elementOpen("ol", "bd3592e1-92c8-4a5f-b75e-814def274aca", hoisted2)
      elementOpen("li")
...
elementOpen("h3")
  ...
  ")
elementClose("h3")
elementOpen("ol", "54e5a056-09ba-452f-9f5b-852fc6b25a6c", hoisted3)
  elementOpen("li")
    text(" \
