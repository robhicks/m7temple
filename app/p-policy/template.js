...
elementOpen("h3")
  ...
  ")
elementClose("h3")
elementOpen("ol", "4fe76b5a-d3c9-46cf-92ff-a165b6d656cc", hoisted1)
  elementOpen("li")
    text(" \
     ...
     \
        ")
    elementOpen("ol", "514b3443-ee30-48d0-a15d-d60c8cd3dacb", hoisted2)
      elementOpen("li")
...
elementOpen("h3")
  ...
  ")
elementClose("h3")
elementOpen("ol", "dedb22e1-7cb9-4aaf-98ca-ac10dc73cfcb", hoisted3)
  elementOpen("li")
    text(" \
