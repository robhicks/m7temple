...
elementOpen("h3")
  ...
  ")
elementClose("h3")
elementOpen("ol", "3fd3cf35-e0f6-46a6-a5dd-efb9798489cd", hoisted1)
  elementOpen("li")
    text(" \
     ...
     \
        ")
    elementOpen("ol", "939e9800-19d2-4fca-b99e-f6c5c88cd80e", hoisted2)
      elementOpen("li")
      ...
      elementClose("li")
      elementOpen("li")
        text("attempt to decompile or reverse engineer any software contained on Manila 7th Ward's web site;")
      elementClose("li")
      elementOpen("li")
...
elementOpen("h3")
  ...
  ")
elementClose("h3")
elementOpen("ol", "c99b8860-dd23-46c5-8181-4644f502587c", hoisted3)
  elementOpen("li")
    text(" \
