...
elementOpen("working-on-gifts")
  ...
  elementOpen("p")
    text(" \
        ...
        ")
    elementOpen("img", "6ccb9449-d6d7-4ed0-8326-a589333d30fa", hoisted1)
    elementClose("img")
  elementClose("p")
  elementOpen("h2")
    text("Adding a Gift")
  ...
  elementOpen("p")
    ...
    elementOpen("img", "19e1b527-9f72-4297-9202-8eb3c5cc965b", hoisted2)
    elementClose("img")
    text(". \
        Once a gift has been added, it can be deleted by clicking the delete button: \
        ")
    elementOpen("img", "4a7755ec-535f-4c3b-a995-45bd0cbf1e38", hoisted3)
    elementClose("img")
    text(", or you can apply for certification by \
        clicking the award button. The award button can take three forms: 1) \
        ")
    elementOpen("img", "5d1f1057-7c35-48d1-bfd8-24445289c2e4", hoisted4)
    elementClose("img")
    text(" when you have added the gift as a \
        goal haven't yet applied for certification, 2) \
        ")
    elementOpen("img", "d99d04bb-5bea-4a74-b9a8-f072020ce1b2", hoisted5)
    elementClose("img")
    text(" when certification is pending, and \
        3) ")
    elementOpen("img", "f684dc87-f9ca-48b1-9b12-2230f92cad34", hoisted6)
    elementClose("img")
  ...
  elementOpen("p")
    text(" \
        ...
        ")
    elementOpen("img", "16219022-f4d9-490d-bf46-7d08911b743d", hoisted7)
    elementClose("img")
  ...
  elementOpen("p")
    ...
    elementOpen("img", "40e4344d-9302-4586-ba6d-366253192af8", hoisted8)
    elementClose("img")
    text(". \
  ...
  elementOpen("p")
    text(" \
        ...
        of the home view. \
        ")
    elementOpen("img", "70fb9118-ded1-4b53-94ca-3db91d188401", hoisted9)
    elementClose("img")
  elementClose("p")
...
elementOpen("technical-issues")
  ...
  elementOpen("p")
    text(" \
        ...
        on ")
    elementOpen("a", "257b9a59-ceae-40a0-bdf0-a64c3846af63", hoisted10)
      text("Github")
    elementClose("a")
    text(". ")
    elementOpen("b")
    ...
    text(" You can also try to get immediat support on \
        ")
    elementOpen("a", "14dceff3-ce9a-4e5b-bd04-f68473e248e0", hoisted11)
      text("Gitter")
    elementClose("a")
    text(". \
      ")
